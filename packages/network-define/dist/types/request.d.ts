...
import { NetworkService, NetworkServiceAdvance, NetworkServiceBase } from './service';
/**
 * 认证参数
 */
...
export declare type RequestParams = {
     ...
     */
    cancel?: Function;
} & Pick<NetworkServiceAdvance, 'feature' | 'beforeRequest' | 'afterResponse'> & Pick<NetworkServiceBase, 'url' | 'method'>;
export declare type RequestOptions = RequestConfig & RequestParams;
/**
 * 返回数据结构协议
 */
 ...
 * 返回数据结构
 */
export declare class NetworkResponse implements iNetworkResponse {
    success: boolean;
    message: string;
    data?: any;
    originData?: any;
 ...
 * 请求处理类基类
 */
export declare class NetworkRequester implements iNetworkRequester {
     ...
     * @param params 参数
     */
    transformPathParams(url: string, path?: {
        [key: string]: any;
    }): string;
    /**
     * 拼接query参数
     ...
     * @param params 参数
     */
    transformQueryParams(url: string, query?: {
        [key: string]: any;
    }): string;
    send(options: RequestOptions): Promise<any>;
